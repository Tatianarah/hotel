...
// un deuxième commentaire en plus
...
public class Reservation {
	 ...
	 * System.out.println("G- Libérer une chambre"); System.out.println("");
	 * System.out.println("Q- Quitter");
	 * 
	 * System.out.println("Votre choix ? "); int choix; choix = sc.nextInt(); return
	 * choix;
	 * 
	 * }
	 */
	...
	public void dernierVide(Hotel h) {
		Scanner sc = new Scanner(System.in);
		int numero = 0;
		for (Chambre c : h.getListeChambre()) {
			if (c.getEtat() == true) {
				numero = h.getListeChambre().size();
